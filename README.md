...
Mappen `text_preprocessing/` indeholder scripts, der kan bruges til forbehandling af tekst, fx tokenisering, rensning og lemmatisering. 
Mappen `leksikalske_analyser/` indeholder scripts, der kan bruges til leksikalske analyser, fx Wordclouds og beregning af ordfrekvens. 
Mappen `semantiske_analyser/` indeholder scripts, der kan bruges til semantiske analyser, fx træning af Word2Vec-modeller, interaktive word embedding plots og opslag i modellerne.  
