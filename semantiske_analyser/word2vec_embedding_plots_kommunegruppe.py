...
# --------------------------------------------------------
# 1) Mappe med modeller for kommunegrupper
# --------------------------------------------------------
MODEL_DIR = os.path.join(ROOT_DIR, "semantiske_analyser", "word2vec_modeller", "kommunegruppe")
BASE_DIR = os.path.join(ROOT_DIR, "semantiske_analyser" ,"word2vec_embedding_plots", "kommunegruppe")
os.makedirs(BASE_DIR, exist_ok=True)

# --------------------------------------------------------
# 2) Vælg kommunegruppe / filtrering
# --------------------------------------------------------
FILTER_KOMTYPE = ["Storbykommuner"] # Vælg kommunegruppe
komtype_str = "_".join(FILTER_KOMTYPE).replace(" ", "_")
MODEL_PATH = os.path.join(MODEL_DIR, f"word2vec_{komtype_str}.model")
...
title_txt = f"Word-embeddings ud fra seed-ord - {' '.join(FILTER_KOMTYPE) if FILTER_KOMTYPE else 'alle kommunetyper'}"
...
# 10) Gem HTML
# --------------------------------------------------------
plot_name = f"word2vec_plot_{komtype_str.lower()}"  # fx word2vec_plot_landkommuner
